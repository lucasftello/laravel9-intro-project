    ...
    <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-2/4 w-full mx-auto overflow-auto">
            <div class="flex items-center justify-between mb-2">
                <h1 class="text-2xl font-medium title-font mb-2 text-gray-900">Editar produto #{{ $product->id }}</h1>
            </div>
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="p-2 w-1/2">
                        <div class="relative">
                            ...
                            <input type="text" id="price" name="price" value="{{ old('price', $product->price) }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                        </div>
                        @error('price')
                            <div class="text-red-400 text-sm">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="p-2 w-1/2">
                        <div class="relative">
                            ...
                            <input type="text" id="stock" name="stock" value="{{ old('stock', $product->stock) }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        </div>
                        @error('stock')
                            <div class="text-red-400 text-sm">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="p-2 w-1/2">
                        <div class="relative">
                            ...
                            <div class="w-full">
                                ...
                                <a href="{{ route('admin.products.destroyImage', $product->id) }}">Deletar imagem</a>
                            </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="p-2 w-full">
                        <button type="submit" class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Salvar</button>
                    </div>
